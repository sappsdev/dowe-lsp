...
The published extension must not depend on a private Dowe checkout. By default, the adapter asks Zed to download `dowe-language-server` from public release assets on `dowe-lang/dowe-lsp`.
