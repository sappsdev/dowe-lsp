...
enum ts_symbol_identifiers {
  ...
  sym_array = 113,
  sym_object = 114,
  sym_object_entry = 115,
  sym_spread = 116,
  sym_method_name = 117,
  sym_type_field = 118,
  sym_type_field_key = 119,
  sym_type_field_name = 120,
  sym_root_keyword = 121,
  sym_block_keyword = 122,
  sym_control_keyword = 123,
  sym_action_keyword = 124,
  sym_component_name = 125,
  sym_identifier = 126,
  sym_punctuation = 127,
  aux_sym_source_file_repeat1 = 128,
  aux_sym_node_line_repeat1 = 129,
  aux_sym_text_line_repeat1 = 130,
  ...
  switch (state) {
    case 0:
      ...
      if (('E' <= lookahead && lookahead <= 'Z') ||
          lookahead == '_' ||
          ('g' <= lookahead && lookahead <= 'z')) ADVANCE(526);
      if (lookahead != 0 &&
          lookahead != '\t' &&
          lookahead != '\n') ADVANCE(748);
      END_STATE();
    ...
    case 27:
      ...
      if (('E' <= lookahead && lookahead <= 'Z') ||
          lookahead == '_' ||
          ('g' <= lookahead && lookahead <= 'z')) ADVANCE(742);
      if (lookahead != 0 &&
          lookahead != '\t' &&
          lookahead != '\n') ADVANCE(748);
      END_STATE();
    ...
    case 745:
      ...
      if (('A' <= lookahead && lookahead <= 'Z') ||
          lookahead == '_' ||
          ('a' <= lookahead && lookahead <= 'z')) ADVANCE(63);
      if ((!eof && set_contains(sym_text_fragment_character_set_1, 12, lookahead))) ADVANCE(748);
      END_STATE();
    case 746:
      ACCEPT_TOKEN(sym_text_fragment);
      if (('0' <= lookahead && lookahead <= '9')) ADVANCE(47);
